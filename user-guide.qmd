...
where H~2~S, C~O~2, N~2~ are impurities.  
...
#### Saving a Model
After entering the fluid properties and selecting the black oil and oil viscosity correlations, the fluid model can be renamed and optional add some description and select “Save Changes” to save the model.  
...
This is used to select the fluid model associatied with the well from existing fluid models.  
...
This tab contains all the inputs and options required to model the wellbor and surface flowline.  

#### Downhole Equipment  
<!-- ![Downhole Equipment](/images/user-guide/well-modeling/downhole-equipment.png)   -->

Each row of data inputs here decribes a downhole equipment. An equipment should have a Label, a type measured depth, diameter and roughness.  
...
The Storage Tank has a lable in the network.  
